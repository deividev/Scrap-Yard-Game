...
export const UPGRADE_DEFINITIONS: UpgradeDefinition[] = [
  // STORAGE UPGRADES
  {
    ...
    baseCostMoney: 30,
    description: '+50 capacidad máxima de Chatarra por nivel',
    effectType: 'storage',
  ...
  },
  {
    ...
    baseCostMoney: 45,
    description: '+20 capacidad máxima de Metal por nivel',
    effectType: 'storage',
  ...
  },
  {
    ...
    baseCostMoney: 45,
    description: '+20 capacidad máxima de Plástico por nivel',
    effectType: 'storage',
  ...
  },
  {
    ...
    baseCostMoney: 80,
    extraCostComponents: 1, // +1 component per level
  ...
  },
  {
    ...
    baseCostMoney: 100,
    description: 'Genera Chatarra automáticamente (0.2/0.5/1.0 por segundo según nivel)',
